...
<html>
    <head>
        ...
        <link rel="stylesheet" href="../Model/css/customer.css?v<?php echo time(); ?>">
        <link rel="stylesheet" href="../Model/css/customerEdit.css?v<?php echo time(); ?>">
    </head>
    <body>
        <div class="container">
            <nav id="navbar">
            ...
            <div class="ssectionbody">
                    <div class="profilemenubar">
                                <ul>
                                    ...
                                    <li>
                                    <a href="customerEdit.php">Edit Customer</a>
                                    </li>
                                    <li>
                                    <a id="load">Show all Customer</a>
                                    </li>
                                </ul>
                        </div>
                        <div id="main">
