...
$conn=new mysqli($servername,$username,$password,$dbname);
	...
	$q="SELECT * FROM divisioncntrl WHERE email='$email'";
	...
	if(isset($_POST["esavebtn"])){
		if($conn->connect_error){
			...
			if($efirstName!="" && $elastName!="" && $epnumber!="" && $eaddress!="" && $edob!="" && $edstrct!="" && $eupzla!="" && $egender!=""){
				...
				$q1 = "UPDATE divisioncntrl SET first_name='$efname', last_name='$elname', phone_number='$epnumber', district='$edstrct', upzilla='$eupzlla',
